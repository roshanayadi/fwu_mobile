    ...
    (function (context) {
        ...
        context.Initialize = function (model) {
            ...
            if (model.SignatureAttachmentId) {
                ajaxRequest('/FileUpload/GetFile/' + model.SignatureAttachmentId, 'GET', null, function (response) {
                    if (response.IsSuccess) {
            ...
            if (model.PhotoAttachmentId) {
                ajaxRequest('/FileUpload/GetFile/' + model.PhotoAttachmentId, 'GET', null, function (response) {
                    if (response.IsSuccess) {
            ...
            context.InitializeFileUpload(null, function (e, file, response) {
                ...
                if (responseObj.IsSuccess && responseObj.Data) {
                    ajaxRequest('/studentportal/dashboard/UpdatePhoto/', 'POST', { data: { id: responseObj.Data.Id } }, function (response) {
                        if (response.IsSuccess) {
            ...
            context.InitializeSignUpload(null, function (e, file, response) {
                var responseObj = JSON.parse(response || "{}");
                if (responseObj.IsSuccess && responseObj.Data) {
                    ajaxRequest('/studentportal/dashboard/UpdateSign/', 'POST', { data: { id: responseObj.Data.Id } }, function (response) {
                        if (response.IsSuccess) {
